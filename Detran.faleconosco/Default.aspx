<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Detran.faleconosco._Default" EnableEventValidation="false" %>
...
<script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js" type="text/javascript" charset="utf8"></script>
    ...
    <asp:GridView ID="grid" class="table table-striped table-hover table-sm" runat="server" AutoGenerateColumns="False" OnRowDataBound="grid_RowDataBound" OnSelectedIndexChanged="grid_SelectedIndexChanged">
        <Columns>
